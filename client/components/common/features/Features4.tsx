export default function Features5({
  parentClass = "rbt-component-area rbt-quick-inf-area rbt-bg-color-white rbt-section-gapTop",
}) {
  return (
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
            <div className="rbt-bg-color-gray-light rbt-rounded--16 p--60 p_sm--20">
              <div className="rbt-inf-box-wrapper rbt-inf-box-wrapper-style-one">
                <ul className="rbt-inf-box-wrapper-list justify-content-center rbt-gap--100">
                  <li>
