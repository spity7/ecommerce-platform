...
function BlogBlock03() {
  return (
    <>
      <div
        id="rbt-blog-area-03"
        className="rbt-component-area rbt-bg-color-gray-light rbt-section-gap"
      >
            ...
            <div className="col-lg-12">
              <div className="rbt-component-section-title text-center">
                <h2 className="rbt-title rbt-scroll-trigger fade_in animation-order-1">
                  <span className="rbt-bold--text">Blog Grid Four Columns</span>
                </h2>
              </div>
            </div>
          </div>
