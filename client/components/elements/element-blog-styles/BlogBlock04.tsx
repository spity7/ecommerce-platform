...
import { blogPosts11 } from "@/data/blogs";
function BlogBlock04() {
  return (
    <>
      <div
        id="rbt-blog-area-04"
            ...
            <div className="col-lg-12">
              <div className="rbt-component-section-title text-center">
                <h2 className="rbt-title rbt-scroll-trigger fade_in animation-order-1">
                  <span className="rbt-bold--text">Blog Grid Five Columns</span>
                </h2>
              </div>
            </div>
          </div>
