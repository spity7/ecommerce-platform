        ...
        <div className="container">
            ...
            <div className="col-lg-12">
              <div className="rbt-component-section-title text-center align-items-center">
                <h2 className="rbt-title rbt-scroll-trigger fade_in animation-order-1">
                  <span className="rbt-bold--text">Recent </span>Products
                </h2>
                <p className="description rbt-scroll-trigger fade_in animation-order-2">
                  Discover the latest additions to our collection. Stay updated
                  with the newest products available in our store.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row row--12">
            ...
            {electronicsCardData.slice(0, 12).map((product, i) => (
              ...
              >
                <ProductCard9 product={product} animationOrder={i + 1} />
              </div>
            ))}
            {/* End Single Card  */}
          </div>
