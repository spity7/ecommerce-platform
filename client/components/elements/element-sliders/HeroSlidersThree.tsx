        ...
        <div className="rbt-full-width-wrapper">
            ...
            <div className="col-lg-12">
              <div className="rbt-component-section-title text-center">
                <h2 className="rbt-title rbt-scroll-trigger fade_in animation-order-1">
                  <span className="rbt-bold--text">Hero Slider </span> Three
                </h2>
              </div>
            </div>
          </div>
          <Swiper
            ...
            {...{
              ...
              pagination: {
                el: ".rbt-hero-banner-activation-3 .rbt-swiper-pagination.hs3",
                clickable: true,
              },
              navigation: {
          ...
          >
            ...
            <div className="rbt-swiper-pagination rbt-swiper-pagination-var-one hs3" />
          </Swiper>
        </div>
      </div>
    </>
...
export default HeroSlidersThree;
