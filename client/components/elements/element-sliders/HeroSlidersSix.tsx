        ...
        <div className="container">
            ...
            <div className="col-lg-12">
              <div className="rbt-component-section-title text-center">
                <h2 className="rbt-title rbt-scroll-trigger fade_in animation-order-1">
                  <span className="rbt-bold--text">Hero Slider </span> Six
                </h2>
              </div>
            </div>
          </div>
          ...
          <div className="row row--12 mt_dec--24">
            <div className="col-lg-12 col-md-12 col-sm-12 col-12 mt--24 d-flex justify-content-center">
              <div className="rbt-swiper-container-one hero-6 rbt-arrow-between">
                <Swiper
                  {...({
                    slidesPerView: 1,
                    spaceBetween: 24,
                    loop: true,
                    pagination: {
                      el: ".hero-6 .rbt-swiper-pagination",
                      clickable: true,
                    },
                    navigation: {
                      prevEl: ".hero-6 .rbt-arrow-left",
                      nextEl: ".hero-6 .rbt-arrow-right",
                      clickable: true,
                    },
                    breakpoints: {
                      575: {
