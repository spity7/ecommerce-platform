      ...
      <div className="rbt-component-area rbt-products-area rbt-section-gap rbt-bg-color-gray-light">
        <div className="container">
            ...
            <div className="col-lg-12">
              <div className="rbt-component-section-title text-center">
                <h2 className="rbt-title rbt-scroll-trigger fade_in animation-order-1">
                  Card Style <span className="rbt-bold--text">Seventeen</span>
                </h2>
              </div>
            </div>
          </div>
          ...
          <div className="row row--12 mt_dec--24">
            {/* Start Single Card  */}
            {accessoriesProducts.slice(0, 4).map((product, i) => (
              <div
                key={i}
...
export default CardStyleSeventeen;
