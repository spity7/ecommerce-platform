function StandardListStyleFive() {
  return (
    <>
          ...
          <div className="row">
            ...
            <div className="col-lg-12 col-md-12 col-12 d-flex justify-content-center">
              <ul className="rbt-list-style-3">
                <li>
                  <i className="fa-regular fa-heart" /> Health and Wellness
                </li>
                <li>
                  <i className="fa-regular fa-flag" /> Literacy and Language
                </li>
                <li>
                  <i className="fa-regular fa-eye" /> Social-Emotional Learning
                </li>
                <li>
                  <i className="fa-regular fa-pen-to-square" /> Visual and
                  Creative Arts
                </li>
                <li>
                  <i className="fa-regular fa-battery-bolt" /> Thinking and
                  Learning
                </li>
              </ul>
            </div>
...
export default StandardListStyleFive;
