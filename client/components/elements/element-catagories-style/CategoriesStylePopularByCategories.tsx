...
function CategoriesStylePopularByCategories() {
  return (
    <>
      {/* Start Component Area */}
      <div
        id="rbt-category-block-12"
        className="rbt-component-area rbt-categories-area rbt-bg-color-white rbt-section-gap2"
      >
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="rbt-component-section-title text-center">
                <h2
                  className="rbt-title rbt-scroll-trigger fade_in animation-order-1"
                  animation-ends=""
                >
                  Popular By
...
export default CategoriesStylePopularByCategories;
