...
function CategoriesStyleBentoBox() {
  return (
    <>
      <div
        id="rbt-category-block-05"
        className="rbt-component-area rbt-categories-area rbt-section-gapTop rbt-bg-color-white"
      >
            ...
            <div className="col-lg-12">
              <div className="rbt-component-section-title text-center">
                <h2 className="rbt-title rbt-scroll-trigger fade_in animation-order-1">
                  Categories Style{" "}
                  <span className="rbt-bold--text">Bento Box</span>
                </h2>
              </div>
            </div>
          </div>
...
export default CategoriesStyleBentoBox;
