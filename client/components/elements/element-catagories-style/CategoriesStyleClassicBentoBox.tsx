...
function CategoriesStyleClassicBentoBox() {
  return (
    <>
      {/* Start Component Area */}
      <div
        id="rbt-category-block-10"
        className="rbt-component-area rbt-categories-area "
      >
...
export default CategoriesStyleClassicBentoBox;
