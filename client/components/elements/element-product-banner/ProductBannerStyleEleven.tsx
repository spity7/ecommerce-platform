...
function ProductBannerStyleEleven() {
  return (
    <>
      <div
        id="rbt-prd-banner-block-11"
            ...
            <div className="col-lg-12">
              <div className="rbt-component-section-title text-center">
                <h2 className="rbt-title">
                  Product Banners <span className="rbt-bold--text">Eleven</span>
                </h2>
              </div>
            </div>
          </div>
...
export default ProductBannerStyleEleven;
