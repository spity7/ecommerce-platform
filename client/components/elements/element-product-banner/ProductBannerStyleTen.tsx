...
function ProductBannerStyleTen() {
  return (
    <>
      <div
        id="rbt-prd-banner-block-10"
            ...
            <div className="col-lg-12">
              <div className="rbt-component-section-title text-center">
                <h2 className="rbt-title">
                  Product Banners <span className="rbt-bold--text">Ten</span>
                </h2>
              </div>
            </div>
          </div>
                ...
                <div className="rbt-banner-inner h-100">
                  <div className="rbt-product-banner-content rbt-content-style-one">
                    <div className="rbt-content-section">
                      ...
                      <h2 className="rbt-banner-title mb-0">
                        <span className="rbt-bold--text">Seal The </span>
                        Matching
                      </h2>
                      <p className="rbt-banner-description">
                        sitar nostrum conctetur Volupq .
...
export default ProductBannerStyleTen;
