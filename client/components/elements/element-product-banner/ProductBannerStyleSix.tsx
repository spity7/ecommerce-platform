...
function ProductBannerStyleSix() {
  return (
    <>
      <div
        id="rbt-prd-banner-block-06"
            ...
            <div className="col-lg-12">
              <div className="rbt-component-section-title text-center">
                <h2 className="rbt-title">
                  Product Banners <span className="rbt-bold--text">Six</span>
                </h2>
              </div>
            </div>
          </div>
                  ...
                  <div className="rbt-product-banner-content has-lg-space-bottom">
                    <div className="rbt-content-section rbt-content-less-wider">
                      ...
                      <p className="rbt-banner-description">
                        Temporibus unde uat exercit ationem nostrum conctetur
                        est wtatem.
                      </p>
...
export default ProductBannerStyleSix;
