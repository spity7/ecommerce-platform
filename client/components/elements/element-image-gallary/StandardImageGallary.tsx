...
import { standardImageGallary } from "@/data/imageGallary";
import "@/lib/lightgallery-styles";
function StandardImageGallary() {
  return (
    <>
        ...
        <div className="container">
            ...
            <div className="col-lg-12">
              <div className="rbt-component-section-title d-flex justify-content-between align-items-center p-0 mb--24 border-0">
                <h2 className="rbt-title rbt-scroll-trigger fade_in animation-order-1">
                  <span className="rbt-bold--text">Standard Image Gallary</span>
                </h2>
              </div>
            </div>
          </div>
          ...
          >
            <div className="row row--12 mt_dec--24 rbt-element-image-gallary-markup">
              {standardImageGallary.map((item) => (
                <div
                  key={item.src}
                  className={"col-lg-4 col-md-4 col-sm-4 col-6 mt--24"}
                >
...
export default StandardImageGallary;
