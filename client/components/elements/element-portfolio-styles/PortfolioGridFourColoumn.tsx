...
import { portfolioGridFourColoumnItems } from "@/data/portfolios";
function PortfolioGridFourColoumn() {
  return (
    <>
      <div className="rbt-team-area rbt-bg-color-white rbt-section-gap">
        <div className="container">
          ...
          <div className="row row--12">
            {portfolioGridFourColoumnItems.map((item, idx) => (
              <div
                key={`${item.title}-${item.img}-${idx}`}
                className="col-lg-4 col-xl-3 col-xxl-3 col-md-6 col-sm-6 col-6 mt--24 mt_sm--16"
              >
...
export default PortfolioGridFourColoumn;
