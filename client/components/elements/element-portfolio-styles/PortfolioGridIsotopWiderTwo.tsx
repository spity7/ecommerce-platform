              ...
              <div className="col-12">
                <div className="grid-5-meso" ref={gridRef}>
                  {filteredItems.length === 0 ? (
                    <div className="no-result text-center w-100 rbt-section-gapBottom pt--28">
                      <p>No portfolio items found for this filter.</p>
                    </div>
                  ) : (
                    isotopPortfoliosWiderTwo.map((item, idx) => {
                      return (
                        <div
...
export default PortfolioGridIsotopWiderTwo;
