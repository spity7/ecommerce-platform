function TitlesStyleDefaultRightDark() {
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="rbt-component-section-title text-end border-0 p-0 mb--0 align-items-end">
                ...
                <h2 className="rbt-title rbt-text-color-white rbt-scroll-trigger fade_in animation-order-1">
                  <span className="rbt-bold--text">Titles Style </span> Default
                  Right
                </h2>
...
export default TitlesStyleDefaultRightDark;
