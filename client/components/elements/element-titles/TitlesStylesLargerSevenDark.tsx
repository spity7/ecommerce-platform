...
function TitlesStylesLargerSevenDark() {
  return (
    <>
                ...
                <div className="container">
                  <div className="row">
                    <div className="col-12">
                      <div className="rbt-exclusive-section-title text-center mb--44">
                        <span className="subtitle rbt-text-color-gray-300 rbt-scroll-trigger fade_in animation-order-1">
                          Subtitle Text
                        </span>
                        <h2 className="rbt-title rbt-text-color-white">
                          <span className="rbt-bold--text rbt-scroll-trigger fade_in animation-order-2">
                            Titles Styles larger <br />
                          </span>
...
export default TitlesStylesLargerSevenDark;
