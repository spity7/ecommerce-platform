...
export default function Lookbook() {
  ...
  return (
    <div className="rbt-component-area rbt-lookbook-area rbt-section-gap rbt-bg-color-white position-relative z-2">
          ...
          <div className="col-lg-12">
            <div className="rbt-component-section-title text-center">
              <h2 className="rbt-title">
                Hotspot Style{" "}
                <span className="rbt-bold--text">Full Width View</span>
              </h2>
            </div>
          </div>
        </div>
            ...
            <div className="rbt-lookbook-section rbt-lookbook-style--two p-0">
              <div className="rbt-lookbook-banner rbt-lookbook-banner-two rbt-scroll-trigger zoom_in animation-order-3">
                ...
                {lookbookLargeProducts.map((item, idx) => (
                  <div
                    key={idx}
                    className={getHotspotClassName(`hotspot-two-${item.id}`)}
                  ...
                  >
                    <button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        toggleHotspot(`hotspot-two-${item.id}`);
                      }}
                    />
                    <div
