...
import { fashionProducts } from "@/data/products/others";

export default function SimillerProducts6() {
  return (
    <div className="rbt-component-area rbt-section-gap rbt-bg-color-gray-white">
