...
export default function DetailsStickyInfo({ product }: { product: Product }) {
  return (
        ...
        <div className="row row--12 mt_dec--24 justify-content-center">
          <div className="col-xl-8 col-lg-12 mt--24">
            <div className="row row--12 justify-content-center mt_dec--16">
              <div className="col-xl-6 col-lg-12 col-12 mt--16 order-xl-2 order-1">
              ...
              <div className="col-xl-6 col-lg-12 col-12 mt--16 order-xl-1 order-2">
