...
import ProductOptionsPanel3 from "../productOptionsPanels/ProductOptionsPanel3";
import Tooltip from "@/components/common/ui/Tooltip";

import { Product } from "@/types";
import { AuthSignInTrigger } from "@/components/auth/storefront-auth-entry";
import ModalTriggerButton from "@/components/action-buttons/ModalTriggerButton";
export default function DetailsFurniture({ product }: { product: Product }) {
  return (
