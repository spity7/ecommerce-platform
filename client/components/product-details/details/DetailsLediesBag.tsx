...
import { fashionComboProducts } from "@/data/products/others";
import ProductOptionsPanel8 from "../productOptionsPanels/ProductOptionsPanel8";

import { Product } from "@/types";

import ModalTriggerButton from "@/components/action-buttons/ModalTriggerButton";
export default function DetailsLediesBag({ product }: { product: Product }) {
  return (
          ...
          <div className="col-xl-8 col-lg-12 mt--24">
            ...
            <div className="rbt-combo-prd-box rbt-bg-color-white mt--24">
              <div className="row justify-content-between">
                ...
                <ComboProducts products={fashionComboProducts} />
              </div>
            </div>
          </div>
