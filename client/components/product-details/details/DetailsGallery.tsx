...
import ProductOptionsPanel14 from "../productOptionsPanels/ProductOptionsPanel14";

import { Product } from "@/types";

import ModalTriggerButton from "@/components/action-buttons/ModalTriggerButton";
export default function DetailsGallery({ product }: { product: Product }) {
  return (
