...
import BundleProducts from "../others/BundleProducts";
import Tooltip from "@/components/common/ui/Tooltip";

import { Product } from "@/types";
import ModalTriggerButton from "@/components/action-buttons/ModalTriggerButton";
export default function DetailsTechAccessories({
  product,
}: {
  product: Product;
}) {
          ...
          <div className="col-xl-5 col-lg-12 col-12 mt--16">
            <div className="rbt-single-product-content ptb--0">
              ...
              <div className="rbt-info-wrapper d-block mt--24">
                <div className="rbt-info-box p-0">
                  <BundleProducts />
                </div>
              </div>
              <div className="rbt-info-wrapper d-flex justify-content-between mt--16">
                <div className="rbt-store-price-default">
