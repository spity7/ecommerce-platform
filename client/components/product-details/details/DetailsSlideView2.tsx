...
import Slider11 from "../sliders/Slider11";
...
export default function DetailsSlideView2({ product }: { product: Product }) {
  return (
      ...
      <div className="container">
        <div className="row row--12 mt_dec--24 justify-content-center">
          <div className="col-xl-8 col-lg-12 mt--24">
            ...
            <hr className="rbt-separator rbt-separator-gray200 mt--20" />
            <div className="mt--24 rbt-tab-area">
              <DescriptionTab1 />
            </div>
          </div>
          <div className="col-xl-4 col-lg-12 mt--24 rbt-single-mobile-view-sidebar">
            <div className="rbt-single-product-content rbt-sticky-top-150">
              <a
                href="#"
