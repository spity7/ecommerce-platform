...
import GalleryZoom1 from "../galleries/GalleryZoom1";
...
export default function DetailsZoom1({ product }: { product: Product }) {
  const { setPane } = useUiElement();
  return (
          ...
          <div className="col-xl-10 col-lg-12 mt--24">
            <div className="row row--12 justify-content-center mt_dec--16">
              <div className="col-xl-6 col-lg-6 col-12 mt--16">
                <GalleryZoom1 imageUrl={product.imgSrc} />
              </div>
              <div className="col-xl-6 col-lg-6 col-12 mt--16">
                <div className="rbt-single-product-content">
                  <div ref={setPane} className="rbt-zoom-main" />
                  <a
                    href="#"
