...
import ProductOptionsPanel9 from "../productOptionsPanels/ProductOptionsPanel9";

import { Product } from "@/types";

import ModalTriggerButton from "@/components/action-buttons/ModalTriggerButton";
export default function DetailsLaggageBag({ product }: { product: Product }) {
  return (
      ...
      <div className="container">
        <div className="row row--12 mt_dec--24 justify-content-center">
          <div className="col-xl-8 col-lg-12 mt--24">
            <div className="row row--24 justify-content-center mt_dec--24 rbt-sticky-top-150">
