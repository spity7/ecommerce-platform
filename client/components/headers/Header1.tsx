...
export default function Header1({ sticky = false }) {
  ...
  return (
    <header className="rbt-header rbt-header-1">
      <div
        className={`rbt-header-wrapper rbt-header-sticky-activation header-space-between rbt-bg-color-gray-light header-not-transparent header-sticky${stickyClass}`}
      >
            ...
            <div className="rbt-header-sec-col rbt-header-right">
              <div className="rbt-header-content">
                <ul className="rbt-quick-access">
                  ...
                  <li className="rbt-access-box rbt-scroll-trigger fade_in animation-order-1 rbt-access-box-var-light-white">
                    <div className="header-info">
                      <CurrencySelect />
                    </div>
                    <div className="header-info">
      ...
      {/* End Header Top */}
      {/* Start Header Bottom */}
      <div className="rbt-header-bottom position-relative rbt-header-bottom-1 rbt-bg-color-gray-light d-none d-xl-block">
        <div className="container">
          <Categories />
        </div>
      </div>
