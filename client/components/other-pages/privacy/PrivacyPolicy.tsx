          ...
          <div className="col-lg-8">
            <div className="rbt-article-content-wrapper">
              <div className="content">
                ...
                <p>
                  We collect various types of information in order to provide a
                  personalized and secure shopping experience for you. This
                  information may include:
                </p>
                <ul>
                  <li>
                    <strong>Personal Information:</strong> Name, email address,
                    phone number, shipping and billing addresses, payment
                    information, and account details.
                  </li>
                  <li>
                    <strong>Non-Personal Information:</strong> Browser type,
                    device type, IP address, location, and browsing activity on
                    our website.
                  </li>
                  <li>
                    <strong>Cookies and Tracking Technologies:</strong> We use
                    cookies and similar technologies to collect information
                    about your activity on our website to improve your user
                ...
                <ul>
                  <li>
                    <strong>Order Processing:</strong> To process and fulfill
                    your orders, including shipping and billing details.
                  </li>
                  <li>
                    <strong>Customer Support:</strong> To provide customer
                    service, respond to inquiries, and resolve issues with your
                    orders.
                  </li>
                  <li>
                    <strong>Improvement of Services:</strong> To improve the
                    functionality and content of our website, enhance your
                    shopping experience, and develop new products and services.
                  </li>
                  <li>
                    <strong>Marketing:</strong> To send you promotional emails,
                    newsletters, and special offers. You can opt-out of these
                    communications at any time by following the unsubscribe link
                    in the email.
                  </li>
                  <li>
                    <strong>Security:</strong> To monitor and protect the
                    security of our website and to detect, prevent, or address
                    fraud, unauthorized activity, or breaches of our policies.
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    ...
                    assist us with order fulfillment, payment processing, email
                    marketing, and other services. These third parties are
                    obligated to protect your information and may only use it to
                    perform services on our behalf.
                  </li>
                  <li>
                    <strong>Legal Compliance:</strong> We may disclose your
                    information if required by law or in response to a legal
                ...
                <p>
                  ...
                  and use industry-standard security measures to protect it from
                  unauthorized access, alteration, disclosure, or destruction.
                  However, no method of data transmission over the Internet or
                  electronic storage is 100% secure, so we cannot guarantee the
                  absolute security of your data. We recommend that you take
                  appropriate measures to protect your personal information when
                  using the internet.
                </p>
                ...
                <ul>
                  <li>
                    ...
                    your account or contacting our customer support team.
                  </li>
                  <li>
                    <strong>Opt-Out:</strong> You can choose to opt out of
                    marketing communications by clicking the unsubscribe link in
                    our emails or by contacting us directly.
                  </li>
                  <li>
                    <strong>Data Deletion:</strong> You can request the deletion
                    of your personal information, subject to legal and
                    contractual obligations.
                  </li>
                  <li>
                    <strong>Cookies:</strong> You can manage or disable cookies
                ...
                <p>
                  ...
                  soon as possible. If you believe that we have collected such
                ...
                <p>
                  ...
                  policies of any third-party sites before providing any
