...
function OfferManagementBanner() {
  return (
    <>
            ...
            <div className="row align-items-center">
              <div className="col-12 col-md-6">
                <div className="rbt-splash-section-title text-center">
                  <span className="subtitle">Offers Management</span>
                ...
                <div className="rbt-banner-part-right">
                  <div className="rbt-content">
                    <figure>
                      <Image
                        alt="Component Image"
                        src="/assets/images/splash/builder-element/offer-management-banner.webp"
                        width={1232}
                        height={846}
                      />
                    </figure>
...
export default OfferManagementBanner;
