...
function StickyCartBuilderBanner() {
  return (
    <>
            ...
            <div className="row align-items-center">
              <div className="col-12 col-md-6">
                <div className="rbt-splash-section-title text-center">
                  <span className="subtitle">Sticky Cart</span>
                ...
                <div className="rbt-banner-part-right">
                  <div className="rbt-content">
                    <figure>
                      <Image
                        alt="Component Image"
                        src="/assets/images/splash/builder-element/sticky-cart-builder-banner.webp"
                        width={1246}
                        height={881}
                      />
                    </figure>
...
export default StickyCartBuilderBanner;
