...
function VariantSwitcherBanner() {
  return (
    <>
            ...
            <div className="row">
              <div className="col-12 col-md-6 d-flex align-items-center justify-content-end">
                <div className="rbt-splash-section-title text-center">
                  <span className="subtitle">Variation Switcher</span>
                  <h1 className="rbt-title mb--24 rbt-text-capitalize">
                    <span className="rbt-bold--text">
                      Advanced Variant Swatches
                      <br />
                    </span>
                    <span className="rbt-title-sm-text">for your products</span>
                  </h1>
                ...
                <div className="rbt-banner-part-right">
                  <div className="rbt-content rbt-has-not-background justify-content-start">
                    <figure>
                      <Image
                        alt="Banner Image"
                        src="/assets/images/splash/builder-element/variant-swatch/variant-swatch-banner.webp"
                        width={1382}
                        height={961}
                      />
                    </figure>
...
export default VariantSwitcherBanner;
