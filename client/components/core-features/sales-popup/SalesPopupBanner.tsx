            ...
            <div className="row align-items-center">
              <div className="col-12 col-md-6">
                <div className="rbt-splash-section-title text-center">
                  <span className="subtitle">Sales Popup</span>
                ...
                <div className="rbt-banner-part-right">
                  <div className="rbt-content">
                    <figure>
                      <Image
                        alt="Component Image"
                        src="/assets/images/splash/builder-element/sales-popop-banner.webp"
                        width={1252}
                        height={998}
                      />
                    </figure>
...
export default SalesPopupBanner;
