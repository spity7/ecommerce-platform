...
function SalePushNotificationBanner() {
  return (
    <>
                ...
                <div className="rbt-banner-part-right">
                  <div className="rbt-content rbt-has-not-background justify-content-start">
                    <figure>
                      <Image
                        alt="Banner Image"
                        src="/assets/images/splash/builder-element/sale-push-notifications-banner.webp"
                        width={1270}
                        height={981}
                      />
                    </figure>
...
export default SalePushNotificationBanner;
