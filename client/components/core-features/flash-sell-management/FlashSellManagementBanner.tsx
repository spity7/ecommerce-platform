...
function FlashSellManagementBanner() {
  return (
    <>
            ...
            <div className="row">
              <div className="col-12 col-md-6 d-flex align-items-center justify-content-end">
                <div className="rbt-splash-section-title text-center">
                  <span className="subtitle">Flash Sell</span>
                ...
                <div className="rbt-banner-part-right">
                  <div className="rbt-content rbt-has-not-background justify-content-start">
                    <figure>
                      <Image
                        alt="Banner Image"
                        src="/assets/images/splash/builder-element/flash-sale-management-banner.webp"
                        width={1340}
                        height={916}
                      />
                    </figure>
...
export default FlashSellManagementBanner;
