            ...
            <div className="row">
              <div className="col-12 col-md-6 d-flex align-items-center justify-content-end">
                <div className="rbt-splash-section-title text-center">
                  <span className="subtitle">Popup &amp; Sidebar</span>
                  ...
                  <p className="rbt-description">
                    Create and customize popup and sidebar search effortlessly
                    with our intuitive builder. Tailor each popup and sidebar to
                    fit your specific needs and ensure your customers have the
                ...
                <div className="rbt-banner-part-right">
                  <div className="rbt-content rbt-has-not-background justify-content-start">
                    <figure>
                      <Image
                        alt="Banner Image"
                        src="/assets/images/splash/builder-element/popup/popup-banner.webp"
                        width={1340}
                        height={802}
                      />
                    </figure>
...
export default PopupBuilderBanner;
