...
function SizeChartBuilderBanner() {
  return (
    <>
              ...
              <div className="col-12 col-md-6">
                <div className="rbt-splash-section-title text-center">
                  ...
                  <p className="rbt-description">
                    Build customizable size charts for your products.
                  </p>
                </div>
              </div>
              <div className="col-12 col-md-6">
                <div className="rbt-banner-part-right">
                  <div className="rbt-content">
                    <figure>
                      <Image
                        alt="Component Image"
                        src="/assets/images/splash/builder-element/size-chart/size-chart-banner.webp"
                        width={1218}
                        height={853}
                      />
                    </figure>
...
export default SizeChartBuilderBanner;
