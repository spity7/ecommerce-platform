              ...
              <div className="col-12 col-md-6">
                <div className="rbt-splash-section-title text-center">
                  ...
                  <p className="rbt-description">
                    Discover all the sales boost features available with various
                    customization options to enhance your product views and
                    increase sales.
                  </p>
                </div>
              </div>
...
export default BoostFeaturesBanner;
