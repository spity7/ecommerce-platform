...
import { lookbookBannerProducts } from "@/data/products/lookbook";
import { useLookbookMobileHotspot } from "@/hooks/useLookbookMobileHotspot";
import { formatCurrency } from "@/lib/price";

export default function Lookbook() {
  const bannerImage = lookbookBannerProducts[0].bannerImg;
  const { getHotspotClassName, toggleHotspot, closeHotspot } =
    useLookbookMobileHotspot();

  return (
    <div className="rbt-component-area rbt-lookbook-area rbt-bg-color-white rbt-section-gap">
                  ...
                  {lookbookBannerProducts.map((item, idx) => (
                    ...
                    >
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          toggleHotspot(`home-ceramics-${item.id}`);
                        }}
                      />
                      <div
