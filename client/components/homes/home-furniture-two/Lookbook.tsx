                ...
                <div className="rbt-lookbook-banner hover-appear-dot-style rbt-lookbook-banner-five">
                  ...
                  {lookbookProducts
                    ...
                    .map((item, i) => (
                      <div
                        key={i}
                        className={getHotspotClassName(`home-furniture-two-1-${item.id}`)}
                      ...
                      >
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            toggleHotspot(`home-furniture-two-1-${item.id}`);
                          }}
                        />
                        <div
                ...
                <div className="rbt-lookbook-banner hover-appear-dot-style rbt-lookbook-banner-five">
                  ...
                  {lookbookProducts
                    ...
                    .map((item, i) => (
                      <div
                        key={i}
                        className={getHotspotClassName(`home-furniture-two-2-${item.id}`)}
                        data-rbt-position-vertical={item.top}
                        data-rbt-position-horigental={item.left}
                      >
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            toggleHotspot(`home-furniture-two-2-${item.id}`);
                          }}
                        />
                        <div
                          className="rbt-dot-lookbook-product-wrapper"
                ...
                <div className="rbt-lookbook-banner hover-appear-dot-style rbt-lookbook-banner-five">
                  ...
                  {lookbookProducts
                    ...
                    .map((item, i) => (
                      <div
                        key={i}
                        className={getHotspotClassName(`home-furniture-two-3-${item.id}`)}
                        data-rbt-position-vertical={item.top}
                        data-rbt-position-horigental={item.left}
                      >
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            toggleHotspot(`home-furniture-two-3-${item.id}`);
                          }}
                        />
                        <div
                          className="rbt-dot-lookbook-product-wrapper"
                ...
                <div className="rbt-lookbook-banner hover-appear-dot-style rbt-lookbook-banner-five">
                  ...
                  {lookbookProducts
                    ...
                    .map((item, i) => (
                      <div
                        key={i}
                        className={getHotspotClassName(`home-furniture-two-4-${item.id}`)}
                        data-rbt-position-vertical={item.top}
                        data-rbt-position-horigental={item.left}
                      >
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            toggleHotspot(`home-furniture-two-4-${item.id}`);
                          }}
                        />
                        <div
                          className="rbt-dot-lookbook-product-wrapper"
                ...
                <div className="rbt-lookbook-banner hover-appear-dot-style rbt-lookbook-banner-five">
                  ...
                  {lookbookProducts
                    ...
                    .map((item, i) => (
                      <div
                        key={i}
                        className={getHotspotClassName(`home-furniture-two-5-${item.id}`)}
                        data-rbt-position-vertical={item.top}
                        data-rbt-position-horigental={item.left}
                      >
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            toggleHotspot(`home-furniture-two-5-${item.id}`);
                          }}
                        />
                        <div
                          className="rbt-dot-lookbook-product-wrapper"
