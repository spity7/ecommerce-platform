import { blogPosts12 } from "@/data/blogs";

import Image from "next/image";
import Link from "next/link";
export default function Blogs() {
  return (
    <div className="rbt-component-area rbt-blog-area rbt-bg-color-white rbt-section-gap2">
        ...
        <div className="row">
          <div className="col-lg-12 d-flex justify-content-between flex-row align-items-end mb--24 flex-wrap rbt-gap--16">
            <div className="rbt-component-section-title rbt-gap--4 mb--0 p-0 border-0">
              <span className="rbt-card-subtitle rbt-card-categories-text mt--0">
                Blog post
              </span>
            ...
            <Link
              className="rbt-btn rbt-btn-secondary rbt-btn-sm-2"
              href={`/blog-default`}
            >
