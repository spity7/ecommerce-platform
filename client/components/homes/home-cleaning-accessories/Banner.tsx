...
export default function Banner() {
  return (
    <div className="rbt-component-area">
      <div className="rbt-product-banner rbt-product-banner-style-four rbt-product-banner-style-four-hv-one rbt-hero-banner rbt-banner-four-var-two rbt-banner-four-var-two-md-size rbt-bg-color-brand-100 rbt-rounded--0 rbt-scroll-trigger fade_in animation-order-3">
        ...
        >
          <Image
            ...
            src="/assets/images/product-banner/product-banner-img-cleaning-02.webp"
            width={3840}
            height={760}
          />
        </div>
