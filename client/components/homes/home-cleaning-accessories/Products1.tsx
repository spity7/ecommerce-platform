...
import { accessoriesProducts3 } from "@/data/products/accessories";
      ...
      <div className="container">
        ...
        <div className="row row--12 mt_dec--24">
                ...
                <div className="rbt-product-banner rbt-product-banner-style-four rbt-product-banner-style-four-h-longer rbt-bottom-position-content rbt-banner-center-style rbt-banner-bgdark-style rbt-scroll-trigger fade_in animation-order-1">
                      ...
                      <div className="rbt-content mw-auto">
                        ...
                        <h3 className="rbt-banner-title mb-0 line-height-normal">
                          <span className="rbt-bold--text d-block">
                            Exclusive Deals: Save Big on <br />
                            Cleaning Essentials!
                          </span>
                        </h3>
                        <div className="rbt-banner-btn mt--16">
                          <Link
                            className="rbt-btn rbt-btn-md rbt-bg-color-secondary"
                            href={`/shop`}
                          >
                            Shop Now
                          </Link>
                  ...
                  <div className="rbt-product-banner-img rbt-full-width-img">
                    <Image
                      ...
                      src="/assets/images/product-banner/product-banner-img-cleaning-sm-01.webp"
                      width={1296}
                      height={1206}
                    />
                  </div>
          ...
          <div className="col-lg-6 col-12 mt--24">
            <div className="row row--12 mt_dec--24">
              {/* Start Single Card  */}
              {accessoriesProducts3.slice(0, 2).map((product, i) => (
                <div
                  key={i}
                  className="col-lg-6 col-xl-6 col-xxl-6 col-md-6 col-sm-6 col-6 mt--24"
                >
                  <ProductCard8
                    btnClass="rbt-btn rbt-bg-color-secondary hover-appear-element bottom-position text-center rbt-btn-sm rbt-square-btn d-block has-left-icon rbt-cart-sidenav-activation"
                    product={product}
                    animationOrder={i + 1}
                  />
                </div>
        ...
        <div className="row row--12">
          {/* Start Single Card  */}
          {accessoriesProducts3.slice(2, 6).map((product, i) => (
            <div
              key={i}
              className="col-lg-4 col-xl-3 col-xxl-3 col-md-6 col-sm-6 col-6 mt--24"
            >
              <ProductCard8
                btnClass="rbt-btn rbt-bg-color-secondary hover-appear-element bottom-position text-center rbt-btn-sm rbt-square-btn d-block has-left-icon rbt-cart-sidenav-activation"
                product={product}
