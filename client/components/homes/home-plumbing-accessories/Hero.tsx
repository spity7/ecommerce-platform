"use client";
import { pumbingBanners } from "@/data/heroSlides";
...
export default function Hero() {
  return (
    <div className="rbt-component-area rbt-products-banner-area rbt-headphone-hero-section-area rbt-bg-color-white">
