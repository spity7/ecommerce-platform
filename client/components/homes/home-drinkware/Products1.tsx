...
import { bottleProducts } from "@/data/products/fashion";
  ...
  return (
    <div className="rbt-component-area rbt-section-gap rbt-bg-color-gray-light">
      <div className="container">
        <div className="row">
          <div className="col-lg-12 d-flex justify-content-between flex-row align-items-end mb--40 mb_sm--32 flex-wrap rbt-gap--16">
            <div className="rbt-component-section-title rbt-gap--4 mb--0 p-0 border-0">
              <h2 className="rbt-title rbt-scroll-trigger fade_in animation-order-1">
                Discover the
                <span className="rbt-bold--text ml--4">World Of Products</span>
              </h2>
            </div>
            <Link
        ...
        <div className="row row--12 mt_dec--24">
                ...
                <div className="rbt-product-banner rbt-product-banner-style-four rbt-product-banner-style-four-h-longer rbt-bottom-position-content rbt-banner-center-style rbt-banner-bgdark-style rbt-scroll-trigger fade_in animation-order-1">
                  ...
                  <div className="rbt-product-banner-img rbt-full-width-img">
                    <Image
                      ...
                      src="/assets/images/product-banner/product-banner-bottle-md-01.webp"
                      width={1296}
                      height={1206}
                    />
                  </div>
          ...
          <div className="col-lg-6 col-12 mt--24">
            <div className="row row--12 mt_dec--24">
              {/* Start Single Card  */}
              {bottleProducts.slice(0, 2).map((product, i) => (
                <div
                  key={i}
        ...
        <div className="row row--12">
          {/* Start Single Card  */}
          {bottleProducts.slice(2, 6).map((product, i) => (
