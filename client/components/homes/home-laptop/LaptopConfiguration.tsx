      ...
      <div className="container">
            ...
            <div className="rbt-component-section-title text-center border-0 p-0 mb--56 mb_sm--32 align-items-center">
              ...
              <h2 className="rbt-title h1 rbt-scroll-trigger fade_in animation-order-1">
                <span className="rbt-bold--text">
                  Let Life Be Lighter, <br /> Said Ultimate Book{" "}
                </span>
              </h2>
              ...
              <div className="d-flex flex-wrap justify-content-center rbt-gap-lr--48">
                <div className="d-flex align-items-center rbt-gap--12">
                  <span className="h1 mb--0 rbt-text-gradient-secondary">
                    1.24kg
                  </span>
        ...
        <div className="row">
          <div className="col-12">
            <figure>
              <Image
                src="/assets/images/product-banner/product-banner-img-laptop-sm-03.webp"
                alt="Banner Image"
                width={1286}
                height={806}
              />
