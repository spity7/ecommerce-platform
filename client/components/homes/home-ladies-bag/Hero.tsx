import { luxuryBagBanners } from "@/data/collections";

import Image from "next/image";
import Link from "next/link";

const LADIES_BAG_HERO_ANIMATION_CLASSES = [
  "animation-order-1",
  "animation-order-2",
  "animation-order-3",
  "animation-order-3",
    ...
    <div className="rbt-component-area rbt-products-banner-area rbt-phone-hero-section-area rbt-bg-color-white">
      <div className="rbt-full-width-wrapper">
        ...
        <div className="row row--12 mt_dec--24">
          {luxuryBagBanners.map((item, index) => {
            const animationClass =
              LADIES_BAG_HERO_ANIMATION_CLASSES[index] ?? "animation-order-1";
            ...
            >
              <div
                className={`rbt-product-banner rbt-product-banner-style-four rbt-product-banner-style-four-h-longer-two rbt-bottom-position-content rbt-banner-center-style rbt-banner-bgdark-style rbt-scroll-trigger fade_in ${animationClass}`}
              >
