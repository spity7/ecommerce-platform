...
export default function Brands3() {
  return (
    <div className="rbt-component-area rbt-brands-area rbt-bg-color-white rbt-section-gap">
      <div className="container">
        ...
        <div className="row row--12 mt_dec--24">
          {brands.map((brand, index) => (
            ...
            >
              <div
                className={`rbt-brand text-center style-four rbt-scroll-trigger fade_in animation-order-${
                  index + 1
                }`}
              >
                <Link href={`/shop-by-brands`}>
                  <div className="rbt-brand-inner">
                    <div
                      className={`brand-image rbt-scroll-trigger fade_in animation-order-${
                        index + 1
                      }`}
                    >
                      {brand.imgSrc && (
