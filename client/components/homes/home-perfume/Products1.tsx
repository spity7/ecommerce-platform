...
import { fashionProducts4 } from "@/data/products/fashion";
              ...
              <div className="col-lg-12">
                <div className="rbt-component-section-title text-center border-0 p-0 align-items-center">
                  <h2 className="rbt-title rbt-scroll-trigger fade_in animation-order-1">
                    Discover{" "}
                    <span className="rbt-bold--text">Our Products </span>
                  </h2>
                </div>
              </div>
            </div>
            ...
            <div className="row row--12">
              <div className="col-md-12">
                <div className="rbt-swiper-container-one rbt-arrow-between">
                  ...
                  >
                    {/* Start Single Card  */}
                    {fashionProducts4.map((product, i) => (
                      <SwiperSlide key={i} className="swiper-slide">
                        <ProductCard5
                          imbBgClass="rbt-bg-color-white"
                          product={product}
                          animationOrder={i + 1}
                        />
                      </SwiperSlide>
