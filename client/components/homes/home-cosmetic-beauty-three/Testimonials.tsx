...
export default function Testimonials({
  ...
  return (
    <div
      className={`rbt-component-area ${sectionSpace ? sectionSpace : "rbt-section-gap"}`}
    >
            ...
            <div className="rbt-swiper-container-one rbt-arrow-between">
              ...
              >
                {productReviews.map((review, index) => {
                  ...
                  const productHref = `/product-single-cosmetic-beauty/${productId}`;
                  return (
                    <SwiperSlide className="swiper-slide" key={index}>
                      <div
                        className={`rbt-product-review rbt-review-wth-product rbt-scroll-trigger fade_in animation-order-${review.order}`}
                      >
