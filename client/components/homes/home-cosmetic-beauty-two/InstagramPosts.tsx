...
import { brandImagePosts } from "@/data/instagramPosts";
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            <div className="rbt-component-section-title rbt-gap--4 mb--32 p-0 border-0 text-center align-items-center">
        ...
        <div className="row row--12 mt_dec--16 justify-content-center">
          {brandImagePosts.map((post, index) => (
            <div
              key={index}
