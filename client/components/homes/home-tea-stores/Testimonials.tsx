"use client";
import { CheckmarkSmallAltIcon } from "../../svg-icons";
import { teaReviews } from "@/data/testimonials";
                          ...
                          {item.product && (
                            <div className="rbt-review-bottom-section rbt-bg-color-gray-100">
                              <div className="rbt-review-bottom-left-part">
                                <div className="rbt-review-prd-img rbt-bg-color-white">
