      ...
      <div className="wrapper p-0">
        <div className="rbt-static-banner rbt-scroll-trigger zoom_in animation-order-1 rbt-bg-color-gray-100 rbt-rounded--0">
          <div className="row row--0 justify-content-end">
            <div className="col-xl-6 col-md-6 col-12">
              <div className="rbt-product-banner-img rbt-scroll-trigger zoom_in animation-order-3 w-auto h-100">
                <Image
                  ...
                  src="/assets/images/product-banner/product-banner-shocks-a-1.webp"
                  width={1920}
                  height={1364}
                  priority
                />
            ...
            <div className="col-xl-6 col-md-6 col-12">
              <div className="rbt-banner-content rbt-banner-content-has-bg-one text-center rbt-banner-has-top-bottom-flash max-w-unset">
                ...
                <h1 className="rbt-lg-title rbt-scroll-trigger fade_in animation-order-2 rbt-bold-text rbt-text-capitalize">
                  <span className="d-block">
                    Inspired by art, Built with performance
                  </span>
                  Keeps rain out, Lets color in.
                </h1>
                <Link
