...
import { socksCategories } from "@/data/categories";
  ...
  return (
    <div className="rbt-component-area rbt-categories-area rbt-bg-color-white rbt-section-gapTop">
      <div className="wrapper plr--80 plr_xl--30 plr_lg--20 plr_md--20 plr_sm--20">
        <div className="rbt-products-area-box rbt-bg-color-brand-50 rbt-rounded--16 rbt-section-gap">
            ...
            <div className="row row--12">
              <div className="col-lg-12">
                <div className="advance-tab-button">
                  <ul
                    className="nav nav-tabs tab-button-style-2 tab-button-style-3"
                    id="myTab-4"
                    role="tablist"
                  >
                    ...
                    <div className="tab-pane fade active show">
                      <div className="content">
                        ...
                        <div className="row row--12 mt_dec--24 rbt-mobile-row">
                          {socksCategories.map((item, index) => (
                            <div
                              className="col-lg-3 col-md-6 col-sm-6 col-6 mt--24"
                              key={index}
                            >
                              <Link
                                className={`rbt-cat-box rbt-cat-box-1 rbt-cat-box-1-lg rbt-cat-box-1-rounded text-center rbt-scroll-trigger fade_in animation-order-${
                                  index + 1
                                }`}
                              ...
                              >
                                <div className="inner">
                                  <div
                                    className={`rbt-image-portion rbt-bg-color-brand-100 rbt-scroll-trigger zoom_in animation-order-${
                                      index + 1
                                    }`}
                                  >
                                    {item.imgSrc && (
