...
import { furnitureBannerSlides } from "@/data/heroSlides";
        ...
        <div className="rbt-banner-curved-style rbt-banner-has-center-curved-style rbt-banner-has-bottom-center-curved-style rbt-rounded--24">
          <Swiper
            ...
            {...{
              ...
              navigation: {
                prevEl: ".furniture-four-hero-prev",
                nextEl: ".furniture-four-hero-next",
              },
              breakpoints: {
                575: {
                  slidesPerView: 1,
          ...
          >
            {furnitureBannerSlides.map((slide, index) => (
                      ...
                      <div className="row row--12 align-items-end">
                        <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                          <div className="rbt-product-banner-content rbt-product-banner-content-white-var pl--0">
                            <div className="rbt-content-section rbt-slideshow-content-inner text-center mx-auto effect_fadeindown">
                              ...
                              <div className="rbt-pricing-part d-flex align-items-center justify-content-center flex-row">
            ...
            <div className="rbt-swiper-arrow rbt-arrow-transparent rbt-arrow-left furniture-four-hero-prev">
              <div className="custom-overflow">
                <i className="rbt-icon fa-regular fa-arrow-left" />
                <i className="rbt-icon-top fa-regular fa-arrow-left" />
              </div>
            </div>
            <div className="rbt-swiper-arrow rbt-arrow-transparent rbt-arrow-right furniture-four-hero-next">
              <div className="custom-overflow">
