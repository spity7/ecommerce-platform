...
import { jPostsExtended } from "@/data/instagramPosts";
import ModalTriggerButton from "@/components/action-buttons/ModalTriggerButton";
export default function InstagramPosts() {
  return (
    <div className="rbt-component-area rbt-quick-inf-area rbt-bg-color-white rbt-section-gap2Bottom">
      <div className="container">
        {/* Start Instagram Posts Area */}
        <div className="row row--12 mt_dec--24 rbt-section-gap2Top">
          {jPostsExtended.map((post, index) => (
            <div
              key={index}
