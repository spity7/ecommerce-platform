...
import { lookbookLargeProducts } from "@/data/products/lookbook";
...
export default function Lookbook() {
  const bannerImg = lookbookLargeProducts[0].bannerImg;
  const { getHotspotClassName, toggleHotspot, closeHotspot } =
    useLookbookMobileHotspot();

  return (
    <div className="rbt-component-area rbt-lookbook-area rbt-section-gap3 rbt-bg-color-white position-relative z-2">
          ...
          <div className="col-lg-12 col-md-12 col-sm-12 col-12 mt--24 text-end">
            <div className="rbt-lookbook-section rbt-lookbook-style--two p-0">
              <div className="rbt-lookbook-banner rbt-lookbook-banner-two rbt-scroll-trigger zoom_in animation-order-3">
                ...
                {lookbookLargeProducts.map((item, idx) => (
                  <div
                    key={idx}
                    className={getHotspotClassName(`home-furniture-${item.id}`)}
                  ...
                  >
                    <button
                      ...
                      aria-label="Open lookbook product"
                      onClick={(e) => {
                        e.stopPropagation();
                        toggleHotspot(`home-furniture-${item.id}`);
                      }}
                    />
                    <div
                    ...
                    >
                      <button
                        type="button"
                        aria-label="Close lookbook product"
                        onClick={(e) => {
                          e.stopPropagation();
                          closeHotspot();
                        }}
