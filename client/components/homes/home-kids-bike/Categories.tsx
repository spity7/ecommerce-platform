...
import { kidsBikeCards } from "@/data/categories";
import { furnitureCards } from "@/data/collections";
              ...
              {activeTab === "categories" && (
                ...
                <div className="content">
                  ...
                  <div className="row row--12 mt_dec--24">
                    {kidsBikeCards.map((item, index) => (
                      <div
                        key={index}
                        className="col-xl-3 col-md-6 col-sm-6 col-6 mt--24"
                      >
