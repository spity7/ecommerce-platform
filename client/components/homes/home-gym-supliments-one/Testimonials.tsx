...
import { animalAccessoriesReviews } from "@/data/testimonials";
  ...
  return (
    <div className="rbt-component-area rbt-section-gapTop">
      <div className="container">
        <div className="row">
          <div className="col-lg-12 d-flex justify-content-between flex-row align-items-end mb--40 mb_sm--20 mb_md--32 flex-wrap rbt-gap--16">
        ...
        <div className="row row--12">
          <div className="col-md-12">
            <div className="rbt-swiper-container-one rbt-arrow-between">
              ...
              >
                {animalAccessoriesReviews.map((review, index) => {
