    ...
    <div className="rbt-component-area rbt-categories-area rbt-bg-color-white rbt-section-gap">
      <div className="container">
        ...
        <div className="row row--12 mt_dec--24 rbt-mobile-row">
          <div className="col-lg-1-5 col-lg-4 col-md-4 col-sm-12 mt--24">
          ...
          <div className="col-lg-2-5 col-lg-8 col-md-8 col-sm-12 mt--24">
              ...
              <div className="inner">
                <div className="rbt-image-portion rbt-bg-color-gray-100 rbt-scroll-trigger zoom_in animation-order-4">
                  <Link href={`/shop-by-category`}>
                    <Image
                      alt="Category Product Images"
                      src="/assets/images/catagory-img/cat-bg-headphones-lg-01.webp"
                      width={1027}
                      height={491}
                    />
                  </Link>
                ...
                <div className="content">
                  <div className="top-content">
                    ...
                    <h5 className="title">
                      <span className="rbt-bold--text">Made for</span> &amp;
                      Solution
                    </h5>
                  </div>
              ...
              <div className="inner">
                <div className="rbt-image-portion rbt-bg-color-gray-100 rbt-scroll-trigger zoom_in animation-order-6">
                  <Link href={`/shop-by-category`}>
                    <Image
                      alt="Category Product Images"
                      src="/assets/images/catagory-img/cat-bg-headphones-lg-02.webp"
                      width={1027}
                      height={491}
                    />
                  </Link>
              ...
              <div className="inner">
                <div className="rbt-image-portion rbt-bg-color-gray-100 rbt-scroll-trigger zoom_in animation-order-8">
                  <Link href={`/shop-by-category`}>
                    <Image
                      alt="Category Product Images"
                      src="/assets/images/catagory-img/cat-bg-headphones-06.webp"
                      width={490}
                      height={490}
                    />
                  </Link>
