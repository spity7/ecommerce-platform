...
import { electronicsData } from "@/data/products/electronics";
...
export default function Products1() {
  ...
  const filteredProducts = useMemo(() => {
    if (activeTab === "view-all") return electronicsData;
  ...
  return (
    <div className="rbt-component-area rbt-products-area rbt-section-gap3Bottom rbt-bg-color-white">
