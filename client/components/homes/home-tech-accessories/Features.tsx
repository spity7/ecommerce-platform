export default function Features() {
  return (
    <div className="rbt-component-area rbt-quick-inf-area rbt-bg-color-white">
      <div className="container">
        <hr className="rbt-separator rbt-separator-gray200 mb--32 rbt-bg-color-gray-100" />
        <div className="row">
        ...
        <hr className="rbt-separator rbt-separator-gray200 mt--32 rbt-bg-color-gray-100" />
      </div>
    </div>
  );
}
