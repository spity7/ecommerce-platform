import { fragranceBanners } from "@/data/collections";
    ...
    <div className="rbt-component-area rbt-products-banner-area rbt-phone-hero-section-area rbt-bg-color-white">
      <div className="rbt-full-width-wrapper">
        ...
        <div className="row row--12 mt_dec--24">
          {fragranceBanners.map((item, index) => (
            <div
              className="col-md-6 col-12 mt--24 d-flex justify-content-center"
              key={index}
            >
              <div
                ...
                <div className="rbt-banner-inner">
                  <div className="rbt-product-banner-content has-bg-black-overlay pb--40">
                    <div className="rbt-content-section rbt-content-section-full-wider">
                      <h5 className="rbt-banner-subtitle mb-0">
