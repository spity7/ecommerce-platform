import { lagBlogPosts } from "@/data/blogs";

import Image from "next/image";
import Link from "next/link";
export default function Blogs() {
  return (
    <div className="rbt-component-area rbt-blog-area rbt-section-gap">
      <div className="container">
        <div className="row">
          <div className="col-lg-12 d-flex justify-content-between flex-row align-items-center flex-wrap rbt-section rbt-section-gap3Bottom rbt-gap--16">
            <div className="rbt-component-section-title rbt-gap--4 p-0 border-0 mb--0">
              <Link
                href={`/blog-default`}
