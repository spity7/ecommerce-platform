...
const hijabSlides = [
  "product-banner-hijab-img-01.webp",
  "product-banner-hijab-img-02.webp",
  "product-banner-hijab-img-03.webp",
  "product-banner-hijab-img-04.webp",
];
                    ...
                    <div className="rbt-content-section rbt-content-less-wider rbt-slideshow-content-inner effect_fadeindown">
                      ...
                      <h1 className="rbt-title mb-0 rbt-text-color-white rbt-text-capitalize">
                        <span className="rbt-bold--text d-block">
                          The first Hijabs collection
                        </span>
                        breathable fabrics and everyday elegance.
                      </h1>
