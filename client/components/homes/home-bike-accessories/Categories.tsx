import { bikeCategories } from "@/data/categories";
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-12 d-flex justify-content-between flex-row align-items-end mb--40 flex-wrap rbt-gap--16">
            ...
            <Link
              className="rbt-btn rbt-btn-secondary-alt rbt-btn-sm-2 rbt-scroll-trigger fade_in animation-order-2"
        ...
        {/* Start Card Area */}
        <div className="row row--8 mt_dec--16 align-items-start">
          {bikeCategories.map((item, index) => (
            ...
            >
              <Link
                ...
                className={`rbt-cat-box rbt-cat-box-1 rbt-cat-box-1-rounded text-center rbt-scroll-trigger fade_in animation-order-${
                  index + 1
                }`}
              >
                <div className="inner">
