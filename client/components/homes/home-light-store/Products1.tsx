...
import { lightingProductsData } from "@/data/products/electronics";
...
export default function Products1() {
  ...
  const filteredProducts = useMemo(() => {
    if (activeTab === "view-all") return lightingProductsData;
    return lightingProductsData.filter((product) =>
      ...
      <div className="wrapper plr--56 plr_lg--60 plr_md--20 plr_sm--20">
        <div className="row">
          <div className="col-lg-12">
            <div className="rbt-component-section-title text-center border-0 p-0 mb--48 align-items-center">
