import { dogCategories } from "@/data/categories";
  ...
  return (
    <div className="rbt-component-area rbt-categories-area rbt-bg-color-white rbt-section-gap">
      <div className="container">
        <div className="row">
          <div className="col-lg-12 d-flex justify-content-between flex-row align-items-end mb_sm--8 rbt-section-gap3Bottom flex-wrap rbt-gap--16">
            <div className="rbt-component-section-title rbt-gap--4 mb--0 p-0 border-0">
              <h2 className="rbt-title rbt-scroll-trigger fade_in animation-order-1">
                World Of <span className="rbt-bold--text">Dog Accessories</span>
              </h2>
            </div>
            <Link
        ...
        <div className="row row--12 mt_dec--24">
          {dogCategories.map((item, index) => (
            <div key={index} className="col-lg-3 col-md-6 col-6 mt--24">
              <div
