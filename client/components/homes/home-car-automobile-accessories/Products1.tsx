...
import { automotiveProducts } from "@/data/products/others";
  ...
  return (
    <div className="rbt-component-area rbt-products-area rbt-bg-color-white">
      <div className="wrapper plr--80 plr_xl--30 plr_lg--20 plr_md--20 plr_sm--20">
        <div className="rbt-products-area-box rbt-bg-color-brand-50 rbt-rounded--16 rbt-section-gap2">
          <div className="row">
            <div className="col-lg-12">
              <div className="rbt-component-section-title text-center border-0 p-0 mb--32">
                <h2 className="rbt-title rbt-scroll-trigger fade_in animation-order-1">
                  Discover Our
                  <span className="rbt-bold--text ml--4">Products</span>
                </h2>
              </div>
            </div>
          </div>
