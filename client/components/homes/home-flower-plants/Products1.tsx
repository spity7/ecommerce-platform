...
import { flowerProducts } from "@/data/products/others";
...
export default function Products1() {
  ...
  const filteredProducts = useMemo(() => {
    if (activeTab === "view-all") return flowerProducts;
    return flowerProducts.filter((product) =>
      product.demoTab?.includes(activeTab)
    );
  }, [activeTab]);

  return (
    <div className="rbt-component-area rbt-products-area rbt-section-gapTop pt--148 pt_sm--72 rbt-bg-color-white">
