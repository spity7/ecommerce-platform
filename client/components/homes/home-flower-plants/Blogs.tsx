import { flowerBlogPosts } from "@/data/blogs";

import Image from "next/image";
import Link from "next/link";
export default function Blogs() {
  return (
    <div className="rbt-component-area rbt-Blog-grid-area rbt-bg-color-white rbt-section-gap">
      <div className="container">
        <div className="row">
          <div className="col-lg-12 d-flex justify-content-between flex-row align-items-center flex-wrap rbt-gap--16 rbt-section-gap3Bottom">
        ...
        <div className="row row--12 mt_dec--24 rbt-mobile-row">
          {flowerBlogPosts.map((post, index) => (
            <div
              key={index}
