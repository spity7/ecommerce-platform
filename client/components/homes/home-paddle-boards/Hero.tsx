...
import { paddleBoatBanners } from "@/data/heroSlides";
...
export default function Hero() {
  return (
    <div className="rbt-component-area rbt-products-banner-area rbt-paddle-hero-section-area rbt-bg-color-white">
      <div className="container-fluid p-0">
        ...
        >
          {paddleBoatBanners.map((item, index) => (
                ...
                <div className="rbt-banner-inner rbt-rounded--0">
                  <div className="rbt-product-banner-content text-left d-flex align-items-end">
                    <div className="rbt-content-section rbt-content-less-wider rbt-slideshow-content-inner effect_fadeindown">
                      <h6 className="rbt-banner-subtitle-two h5 font-weight-regular mb-0 rbt-text-color-white">
                        {item.subtitle}
                      </h6>
