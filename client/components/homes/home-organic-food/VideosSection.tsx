...
import { ORGANIC_VIDEOS } from "@/data/videoSections";
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            <div className="rbt-component-section-title text-center border-0 p-0 mb--32 mb_sm--20">
