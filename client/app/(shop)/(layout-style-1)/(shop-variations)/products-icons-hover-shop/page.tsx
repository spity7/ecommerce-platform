...
export const metadata: Metadata = {
  title:
    "Icons Hover Products Shop || Unimart - eCommerce React Nextjs Bootstrap5 Template",
...
export default function page() {
  return (
    <>
      <Breadcrumb title="Icons Hover Products" />
      <Banner />
      <Categories />
      ...
      <ShopDefault products={accessoriesProducts} cardVariant="icons-hover" />
    </>
  );
}
