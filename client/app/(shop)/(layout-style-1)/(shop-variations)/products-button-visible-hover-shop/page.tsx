...
export const metadata: Metadata = {
  title:
    "Button Visible Hover Products Shop || Unimart - eCommerce React Nextjs Bootstrap5 Template",
...
export default function page() {
  return (
    <>
      <Breadcrumb title="Button Visible Hover Products" />
      <Banner />
      <Categories />
      ...
      <ShopDefault
        products={printingServiceProducts2}
        cardVariant="button-visible-hover"
      />
    </>
  );
}
