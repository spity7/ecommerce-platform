...
export const metadata: Metadata = {
  title:
    "Button On Image Signin Products Shop || Unimart - eCommerce React Nextjs Bootstrap5 Template",
...
export default function page() {
  return (
    <>
      <Breadcrumb title="Button On Image Signin Products" />
      <Banner />
      <Categories />
      ...
      <ShopDefault
        ...
        cardVariant="button-on-image-signin"
      />
    </>
  );
}
