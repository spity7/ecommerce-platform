...
import DetailsBuyMoreOption from "@/components/product-details/details/DetailsBuyMoreOption";
...
export const metadata: Metadata = {
  title:
    "Product Single Buy More Option || Unimart - eCommerce React Nextjs Bootstrap5 Template",
...
export default async function Page({
  ...
  return (
    <>
      ...
      <DetailsBuyMoreOption product={product} />
