...
import DetailsSlideViewFour from "@/components/product-details/details/DetailsSlideViewFour";
import BreadCrumb from "@/components/product-details/BreadCrumb";
import { Metadata } from "next";

export const metadata: Metadata = {
  title: "Product Single Side View 04 | Beauty Station | Cosmetics & Skincare",
  description:
...
export default async function Page({
  ...
  return (
    <>
      ...
      <DetailsSlideViewFour product={product} />
      <BottomStickyProduct />
      <Footer10 />
    </>
  );
