...
import DetailsStickyThumbs from "@/components/product-details/details/DetailsStickyThumbs";
import BreadCrumb from "@/components/product-details/BreadCrumb";
import { Metadata } from "next";

export const metadata: Metadata = {
  title:
    "Product Single Sticky Thumb || Unimart - eCommerce React Nextjs Bootstrap5 Template",
...
export default async function Page({
  ...
  return (
    <>
      ...
      <DetailsStickyThumbs product={product} />
      <BottomStickyProduct />
      <Footer10 />
    </>
  );
