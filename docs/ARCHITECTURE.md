...
| Admin  | Catalog CRUD + sign-in + orders list/detail + **review moderation**; rich catalog forms; product attribute picker; nav filtered by `SiteConfig.features`; dashboard greeting uses signed-in name                                                                                                                                                    | Dashboard widgets, customers, coupons, settings, reports (~30 demo pages) |
